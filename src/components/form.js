...
function FeedbackForm() {
    ...
    const feedback_type = {
        ...
        'roc': 'How satisfied are you with the academic advising services',
        'exp': 'How would you rate the overall learning atmosphere'
    };
    ...
    return (
        <Container>
            ...
            (<Card>
                <Card.Header>
                    <cite title="Source Title"><strong>Your feedback is important to us, so please share your thoughts to help us serve you better, so we welcome your comments.</strong></cite>
                </Card.Header>
                <Card.Body>
                        ...
                        <Row>
                            <Col>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    ...
                                    <Form.Control type="text" required placeholder="E.g. Harshit " value={nm_value} onChange={e => setNmValue(e.target.value)} />
